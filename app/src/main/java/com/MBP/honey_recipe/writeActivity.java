...
public class writeActivity extends AppCompatActivity {
    ...
    private String recipeTitle, recipeIngredient, recipeContent, recipeCategory, resultImageUri;
        ...
        if (requestCode == REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                try {
                    ...
                    file = data.getData();
                    Glide.with(getApplicationContext()).load(file).into(recipeImage[pos]);
    ...
    public void recipeWrite() {
        ...
        ;
        recipeContent = ((EditText) findViewById(R.id.recipeContent)).getText().toString();
        ;
                                    ...
                                    recipeImageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            Recipes recipes = new Recipes(recipeId, user.getUid(), recipeTitle, recipeCategory, recipeContent, recipeIngredient,
                                                    resultImageUri, Step, images, created, "0", "0");
